...
import 'driver/local_storage.dart' as _i9;
import 'port/activity_port.dart' as _i3;
import 'port/category_port.dart' as _i4;
import 'port/study_log_port.dart' as _i7;
import 'port/user_credential_port.dart' as _i8;
import 'presenter/activity_presenter.dart' as _i10;
import 'presenter/category_list_presenter.dart' as _i5;
...
import 'state/activity_view_state.dart' as _i11;
import 'state/category_list_view_state.dart' as _i6;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i5.CategoryListPresenter>(
      () => _i5.CategoryListPresenter(get<_i6.CategoryListViewState>()));
  gh.factory<_i7.StudyLogPort>(() => _i7.StudyLogGateway());
  gh.factory<_i8.UserCredentialPort>(
      () => _i8.UserCredentialGateway(get<_i9.LocalStorage>()));
  gh.factory<_i10.ActivityPresenter>(
      () => _i10.ActivityPresenter(get<_i11.ActivityViewState>()));
  ...
  gh.factory<_i14.GetActivitiesUsecase>(() => _i14.GetActivitiesUsecase(
      get<_i3.ActivityPort>(), get<_i10.ActivityPresenter>()));
  ...
  gh.factory<_i19.LoginUsecase>(() => _i19.LoginUsecase(
      get<_i8.UserCredentialPort>(), get<_i17.LoginPresenter>()));
  ...
  gh.factory<_i23.StudyRegisterUsecase>(() => _i23.StudyRegisterUsecase(
      get<_i7.StudyLogPort>(), get<_i8.UserCredentialPort>()));
  gh.factory<_i24.CategoryRegistrationUsecase>(() =>
      _i24.CategoryRegistrationUsecase(get<_i4.CategoryPort>(),
          get<_i20.RegisterPresenter>(), get<_i8.UserCredentialPort>()));
  ...
  gh.factory<_i28.GetCategoryUsecase>(() => _i28.GetCategoryUsecase(
      ...
      get<_i8.UserCredentialPort>(),
      get<_i5.CategoryListPresenter>(),
      get<_i12.ChildCategoryListPresenter>()));
  gh.singleton<_i11.ActivityViewState>(_i11.ActivityViewState());
  gh.singleton<_i6.CategoryListViewState>(_i6.CategoryListViewState());
  ...
  gh.singleton<_i9.LocalStorage>(_i9.LocalStorage());
